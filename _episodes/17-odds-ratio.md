...
# Instead, please edit 17-odds-ratio.md in _episodes_rmd/
...
data:  data
X-squared = 89.448, df = 1, p-value < 2.2e-16
~~~
{: .output}
## wald testen.
...
Call:
glm(formula = cbind(vundet, tabt) ~ hjemmebane, family = binomial, 
    data = data)

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  -3.5066     0.4143  -8.463  < 2e-16 ***
hjemmebane    1.8061     0.4775   3.783 0.000155 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

(Dispersion parameter for binomial family taken to be 1)

    Null deviance: 1.7620e+01  on 1  degrees of freedom
